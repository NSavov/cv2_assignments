...
for img_n = {img_names{2+offset:end}}
    ...
    descriptor_list{end+1} = {f1, d1, f2, d2, matches, inlier_indices};
%     if isequal(img_names{end},img_n{1})
%         descriptor_list{end+1} = {f2, d2};
%     end
...
save('descriptor_list.mat', 'descriptor_list')

% point_view_matrix = construct_pointview_matrix(descriptor_list);
