function [ Closest_points_pc ] = get_closest_point_to_target(Source_pc, Target_pc, sampling_technique, sample_size, R, t)
%FIND_CLOSEST_POINT_TO_TARGET Summary of this function goes here
%   Detailed explanation goes here
    Source_pc = R*Source_pc + t;
    sample(Source_pc, sampling_technique, sample_size);
